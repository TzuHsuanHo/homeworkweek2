...
read_excel('/Users/zixuan/Desktop/homeworkweek2/Data/reef_fish.xlsx') # automatically print on my screen
fish<-read_excel('/Users/zixuan/Desktop/homeworkweek2/Data/reef_fish.xlsx') # store my table in an object called `fish`
fish # print my object `fish`   

# importing a .txt file
fish<-read.table('/Users/zixuan/Desktop/homeworkweek2/Data/reef_fish.txt', header=T, sep='\t', dec='.') 
